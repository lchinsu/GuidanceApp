The Front End Application is built in Angular 12.

To redirect the application to the GuidanceWebAPI, please change the config in the environments files which are under src\environments folder
